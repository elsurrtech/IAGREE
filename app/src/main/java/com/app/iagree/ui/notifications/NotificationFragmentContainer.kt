 ...
 * Use the [NotificationFragmentContainer.newInstance] factory method to
...
class NotificationFragmentContainer : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment NotificationFragmentContainer.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            NotificationFragmentContainer().apply {
