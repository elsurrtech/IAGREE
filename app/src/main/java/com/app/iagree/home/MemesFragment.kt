...
class MemesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerView = view.findViewById(R.id.recyclerView_memes_fragment)
        ...
        //loader
        val loaderFragmentDashboard = view.findViewById<LinearLayout>(R.id.loader_fragment_meme)
    ...
    private fun retrievePosts(){
        ...
        val postRef = FirebaseDatabase.getInstance().reference
            .child("Posts").orderByChild("postCategory").equalTo("Meme")

        postRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(p0: DataSnapshot) {
                postList?.clear()

                val a : Long = p0.childrenCount

                loader_layout_meme?.visibility = View.GONE
